...
# 수도권 시군구코드 (서울 25개 구 + 경기 주요 구/시 + 인천 구)
SIGUNGU_CODE_MAP: dict[str, str] = {
    ...
    "일산동구": "41285",
    "일산서구": "41287",
    # 경기도 — 구 없는 시 (주소에 시명 포함)
    "의정부시": "41150",
    "부천시": "41190",
    "평택시": "41220",
    # 인천광역시 구 (서울 구명과 충돌하지 않는 것만)
    "미추홀구": "28177",
    "연수구": "28185",
    "남동구": "28200",
    "부평구": "28237",
    "계양구": "28245",
    "서구": "28260",   # 서울에 '서구' 없음 — 충돌 없음
    "동구": "28140",   # 서울에 '동구' 없음 — 충돌 없음
    # 인천 중구(28110)는 서울 중구(11140)와 키 충돌로 제외
}
