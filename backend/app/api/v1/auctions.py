...
def _auction_to_list_item(auction: Auction, score: Score | None) -> AuctionListItem:
    ...
    return AuctionListItem(
        ...
        nearest_station_name=(auction.location_data or (auction.detail or {}).get("location_data") or {}).get("nearest_station_name"),
        nearest_station_line=(auction.location_data or (auction.detail or {}).get("location_data") or {}).get("nearest_station_line"),
